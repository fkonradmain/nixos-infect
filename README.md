...
| `$NIXOS_IMPORT`             | config file, ideally stored at `/etc/nixos/host.nix`, that is used to extend the configuration.nix that is generated by this script. The file will be kept as is when NixOS is installed | any valid path                                                                                                                                                                                         | `""`                            |
...
| `$NIXOS_CONFIG`             | see [nixos-rebuild manpage](https://web.archive.org/web/20241016161340/https://www.mankier.com/8/nixos-rebuild#Environment-NIXOS_CONFIG)                                                 | `""`                                                                                                                                                                                                   |
